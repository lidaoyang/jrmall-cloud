package com.jrmall.cloud.auth.oauth2.extension.refresh;
...
import static com.jrmall.cloud.auth.util.OAuth2AuthenticationProviderUtils.getAuthenticatedClientElseThrowInvalidClient;
