package com.jrmall.cloud.auth.oauth2.jackson;
...
class SysUserDeserializer extends JsonDeserializer<SysUserDetails> {
    ...
    public SysUserDetails deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        SysUserDetails result = new SysUserDetails(userId, username, password, enabled, dataScope, deptId, accountNonExpired, credentialsNonExpired, accountNonLocked,
                authorities);
