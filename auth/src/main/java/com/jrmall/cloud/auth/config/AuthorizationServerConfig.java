...
import com.jrmall.cloud.auth.oauth2.handler.*;
...
import com.jrmall.cloud.auth.model.SysUserDetails;
import com.jrmall.cloud.auth.oauth2.extension.captcha.CaptchaAuthenticationConverter;
import com.jrmall.cloud.auth.oauth2.extension.captcha.CaptchaAuthenticationProvider;
import com.jrmall.cloud.auth.oauth2.extension.captcha.CaptchaAuthenticationToken;
import com.jrmall.cloud.auth.oauth2.extension.password.PasswordAuthenticationConverter;
import com.jrmall.cloud.auth.oauth2.extension.password.PasswordAuthenticationProvider;
import com.jrmall.cloud.auth.oauth2.extension.refresh.CustomRefreshTokenAuthenticationProvider;
import com.jrmall.cloud.auth.oauth2.jackson.SysUserMixin;
import com.jrmall.cloud.auth.oauth2.oidc.CustomOidcAuthenticationConverter;
import com.jrmall.cloud.auth.oauth2.oidc.CustomOidcAuthenticationProvider;
import com.jrmall.cloud.auth.oauth2.oidc.CustomOidcUserInfoService;
...
public class AuthorizationServerConfig {
        ...
        http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
                ...
                .tokenEndpoint(tokenEndpoint -> tokenEndpoint
                        ...
                        .authenticationProviders(
                                ...
                                {
                                    // 移除默认的Token授权模式提供者(Provider)
                                    authenticationProviders.removeIf(
                                            provider -> provider instanceof OAuth2RefreshTokenAuthenticationProvider
                                    );
    ...
    private void initMallAdminClient(JdbcRegisteredClientRepository registeredClientRepository) {
        ...
        RegisteredClient mallAppClient = RegisteredClient.withId(id)
                ...
                .redirectUri("http://127.0.0.1:9527/OAuth2Redirect")
                ...
                .tokenSettings(TokenSettings.builder()
                        ...
                        .reuseRefreshTokens(false) // 设置每次 refresh_token 都是新的,过期时间也会更新
                        .build())
