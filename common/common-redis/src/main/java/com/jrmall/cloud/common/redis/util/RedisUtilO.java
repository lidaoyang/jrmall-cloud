package com.jrmall.cloud.common.redis.util;
...
public class RedisUtilO {
    ...
    public RedisUtilO(RedisTemplate<String, Object> redisTemplate) {
     ...
     */
    public void batchSet(Map<String, Object> kvMap) {
     ...
     */
    public void batchSetOrExpire(Map<String, Object> map, Long seconds) {
        RedisSerializer<Object> serializer = (RedisSerializer<Object>) redisTemplate.getValueSerializer();
        redisTemplate.executePipelined((RedisCallback<Object>) connection -> {
            map.forEach((key, value) -> {
                connection.set(Objects.requireNonNull(redisTemplate.getStringSerializer().serialize(key)), Objects.requireNonNull(serializer.serialize(value)),
