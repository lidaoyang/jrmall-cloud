...
export function getRoleOptions(
  ...
  return request({
    url: "/sys-api/api/v1/roles/options",
    method: "get",
    params: queryParams,
  });
}
...
export function getRoleMenuIds(roleId: number): AxiosPromise<number[]> {
  return request({
    url: "/sys-api/api/v1/roles/" + roleId + "/menuIds",
    method: "get",
  });
}
...
export function updateRoleMenus(
  ...
  return request({
    url: "/sys-api/api/v1/roles/" + roleId + "/menus",
    method: "put",
    data: data,
  });
}
...
export function getRoleForm(id: number): AxiosPromise<RoleForm> {
  return request({
    url: "/sys-api/api/v1/roles/" + id + "/form",
    method: "get",
  });
}
