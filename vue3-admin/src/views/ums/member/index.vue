      ...
      <el-table-column type="expand" width="120" label="会员地址">
        <template #default="scope">
          <el-table :data="scope.row.addressList" size="small" border>
            <el-table-column align="center" label="地址ID" prop="id" />
            <el-table-column align="center" label="收货人" prop="consigneeName" />
            <el-table-column align="center" label="联系方式" prop="consigneeMobile" />
