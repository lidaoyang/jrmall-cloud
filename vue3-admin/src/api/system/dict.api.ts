...
const DICT_BASE_URL = "/sys-api/api/v1/dict";
...
const DictAPI = {
  ...
  getDictItemPage(dictCode: string, queryParams: DictItemPageQuery) {
    return request<any, PageResult<DictItemPageVO[]>>({
      url: `${DICT_BASE_URL}/${dictCode}/item/page`,
      method: "get",
      params: queryParams,
    });
  },
  ...
  getDictItems(dictCode: string) {
    return request<any, DictItemOption[]>({
      url: `${DICT_BASE_URL}/${dictCode}/item/list`,
      method: "get",
    });
  },
  ...
  createDictItem(dictCode: string, data: DictItemForm) {
    return request({
      url: `${DICT_BASE_URL}/${dictCode}/item/add`,
      method: "post",
      data: data,
    });
  },
  ...
  getDictItemFormData(dictCode: string, id: string) {
    return request<any, DictItemForm>({
      url: `${DICT_BASE_URL}/${dictCode}/item/${id}/form`,
      method: "get",
    });
  },
  ...
  updateDictItem(dictCode: string, id: string, data: DictItemForm) {
    return request({
      url: `${DICT_BASE_URL}/${dictCode}/item/${id}`,
      method: "put",
      data: data,
    });
  },
  ...
  deleteDictItems(dictCode: string, ids: string) {
    return request({
      url: `${DICT_BASE_URL}/${dictCode}/item/${ids}`,
      method: "delete",
    });
  },
};
