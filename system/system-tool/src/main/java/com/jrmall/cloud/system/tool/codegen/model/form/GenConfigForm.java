package com.jrmall.cloud.system.tool.codegen.model.form;
...
@Data
public class GenConfigForm implements Serializable {
    ...
    @Schema(description = "包名",example = "com.jrmall.cloud")
